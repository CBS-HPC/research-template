...
def create_with_uv():
    ...
    try:
        ...
        subprocess.run(
            ["uv", "add","uv", "pip", "setuptools", "wheel", "python-dotenv","_distutils_hack"],
            check=True,
        ...
        try:
            subprocess.run(
                ["uv", "add", "uv", "pip", "setuptools", "wheel", "python-dotenv","_distutils_hack", "--link-mode=copy"],
                check=True,
                stdout=subprocess.DEVNULL,
                stderr=subprocess.DEVNULL,
            )
            ...
            subprocess.run(
                [sys.executable, "-m", "pip", "install","uv", "pip", "setuptools", "wheel", "python-dotenv","_distutils_hack"],
                check=True,
                stdout=subprocess.DEVNULL,
                stderr=subprocess.DEVNULL,
            )
