...
def datalad_create():
    ...
    if not os.path.isdir(".datalad"):
        files_to_unlock = ["src/**","R/**","stata/**","setup/**","docs/**","config/**","README.md", "LICENSE.txt","environment.yml","setup.ps1","setup.sh","CITATION.cff","dmp.json","hardware_information.txt"] # FIX ME
