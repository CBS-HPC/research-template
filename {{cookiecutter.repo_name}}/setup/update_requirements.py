...
def update_requirements(dependencies_files: list = ["src/software_dependencies.txt"], 
...
if __name__ == "__main__":
    update_requirements(dependencies_files=["src/software_dependencies.txt", "setup/setup_dependencies.txt"], 
                                 sections=["src", "setup"])
